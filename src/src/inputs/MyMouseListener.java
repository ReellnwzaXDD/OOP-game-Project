...
public class MyMouseListener implements MouseListener, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		case GAME_OVER:
			...
			break;
		case VICTORY:
			game.geVictory().mouseMoved(e.getX(), e.getY());
			break;
		default:
			break;
		}
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			case GAME_OVER:
				...
				break;
			case VICTORY:
				game.geVictory().mouseClicked(e.getX(), e.getY());
				break;
			default:
				break;
			}
	...
	public void mousePressed(MouseEvent e) {
		...
		case GAME_OVER:
			...
			break;
		case VICTORY:
			game.geVictory().mousePressed(e.getX(), e.getY());
			break;	
		default:
			break;
		}
	...
	public void mouseReleased(MouseEvent e) {
		...
		case GAME_OVER:
			...
			break;
		case VICTORY:
			game.geVictory().mouseReleased(e.getX(), e.getY());
			break;
		default:
			break;
		}
